...
Router.route('/workflow',{
	waitOn: function () {
 		return [Meteor.subscribe('uploads'),Meteor.subscribe('nodes'),Meteor.subscribe('campaigns'),Meteor.subscribe('workflows'),Meteor.subscribe('rules'),Meteor.subscribe('edges')];
 	},
 	action: function () {
 		if (this.ready())
